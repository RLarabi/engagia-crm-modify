...
<html lang="fr">
    <head>
        ...
        <!-- Webpage Title -->
        <title>Engagia CRM immobilier</title>
    ...
    <body data-bs-spy="scroll" data-bs-target="#navbarExample">
        ...
        <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
            <div class="container">
                ...
                <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                    ...
                    <span class="nav-item">
                        <a class="btn-outline-sm" href="{{ route('login') }}">Se connecter</a>
                    </span>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1 class="h1-large">L'application CRM immobilier n°1 pour <span class="replace-me">petite entreprise, grand projet</span></h1>
                            ...
                            <button class="btn-solid-lg" data-bs-toggle="modal" data-bs-target="#demo">Demande de démo</button>
        ...
        <!-- Details Modal -->
        <div id="demo" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="image-container">
                                <img class="img-fluid" src="{{ asset('frontend/images/details-modal.jpg') }}" alt="alternative">
                            </div> <!-- end of image-container -->
                        </div> <!-- end of col -->
                        <div class="col-lg-4">
                            <h3>Demmande de démo</h3>
                            <hr>
                            <p>Envoyer nous une demmande démonstration pour tester les fonctionnalité de notre CRM.</p>
                            <h4>Information du client</h4>
                            <p>Veuillez remplire les information suivante pour pouvoir tréter votre demmande dans le bréve delée.</p>
                            
                            <ul class="message"> </ul>

                            <form action="{{ route('demo') }}" method="POST" id="demo-form" novalidate>

                                @csrf

                                <div class="mb-4 form-floating">
                                    <input type="text" class="form-control" id="name" name="full_name" placeholder="Tariq Belhanna">
                                ...
                                <div class="mb-4 form-floating">
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="0637849873">
                                    <label for="phone">Téléphone</label>
                                </div>
                                
                                <div class="mb-4 form-floating">
                                    <input type="text" class="form-control" id="society" name="society" placeholder="Engagia">
                                    <label for="society">Société</label>
                                </div>

                                <button type="submit" id="demo-send" class="btn-solid-reg">

                                    Envoyer
                                
                                </button>
                                
                                <button type="button" class="btn-outline-reg" data-bs-dismiss="modal">Annuler</button>
        ...
        <div id="features" class="cards-1">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="h2-heading">L'application Engagia CRM regorge de <span>fonctionnalités impressionnantes</span></h2>
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h2>Gérez vos projets immobiliers et concentrez vous sur vos probléme majeur.</h2>
        ...
        <div id="pricing" class="cards-2 bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="h2-heading">Plans des prix</h2>
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="price">600 DH<span>/month</span></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="price">800 DH<span>/month</span></div>
                                <a href="sign-up.html" class="btn-solid-reg">Sign up</a>
                            </div>
                        </div>
                        <!-- end of card -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="price">200 DH<span>/month</span></div>
                                <a href="sign-up.html" class="btn-solid-reg">Sign up</a>
                            </div>
                        </div>
                        <!-- end of card -->
        ...
        <div class="accordion-1">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="h2-heading">Questions fréquentes</h2>
                    </div> <!-- end of col -->
                </div> <!-- end of row -->   
                <div class="row">
                    <div class="col-lg-12">
        ...
        <div class="copyright">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <p class="p-small">Copyright &copy; Engagia CRM</p>
                    </div> <!-- end of col -->

                    <div class="col-lg-6">
                        <p class="p-small">Distribué par <a href="https://www.engagia.ma"> Engagia Communication</a></p>    
                    </div> <!-- end of col -->
                </div> <!-- enf of row -->
            </div> <!-- end of container -->
        ...
        <script src="{{ asset('frontend/js/replaceme.min.js') }}"></script> <!-- ReplaceMe for rotating text -->
